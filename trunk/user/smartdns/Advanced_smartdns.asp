                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box well grad_colour_dark_blue">
                            <h2 class="box_head round_top"><#menu5_13_0#> - <#menu5_24#></h2>
                            <div class="round_bottom">
                                ...
                                <div>
                                    <ul class="nav nav-tabs" style="margin-bottom: 10px;">
                                        ...
                                        <li>
                                            <a id="tab_sm_cou" href="#cou">自定义设置</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="row-fluid">
                                ...
                                <div id="wnd_sm_cfg">
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            <th width="50%" style="border-top: 0 none"><#menu5_24_1#></th>
                                        ...
                                        <tr> <th width="50%">服务器名称</th>
                                            <td>
                                                <input type="text" maxlength="15" class="input" size="15" name="snds_name" style="width: 180px" value="<% nvram_get_x("","snds_name"); %>">
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="snds_cache_option">
                                            <th width="50%">缓存大小</th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="snds_cache" style="width: 120px" value="<% nvram_get_x("", "snds_cache"); %>">
                                                <div><span style="color:#888;">缓存DNS的结果，缓存大小，配置零则不缓存</span></div>
                                            </td>
                                        </tr>

                                        <tr id="sdns_ttl_option">
                                            <th width="50%">域名TTL</th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="sdns_ttl" style="width: 120px" value="<% nvram_get_x("", "sdns_ttl"); %>">
                                                <div><span style="color:#888;">设置所有域名的TTL</span></div>
                                            </td>
                                        </tr>

                                        <tr id="sdns_ttl_min_option">
                                            <th width="50%">域名TTL最小值</th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="sdns_ttl_min" style="width: 120px" value="<% nvram_get_x("", "sdns_ttl_min"); %>">
                                                <div><span style="color:#888;">设置所有域名的TTL最小值</span></div>
                                            </td>
                                        </tr>

                                        <tr id="sdns_ttl_max_option">
                                            <th width="50%">域名TTL最大值</th>
                                            <td>
                                ...
                                <div id="wnd_sm_sec">
                                    <table width="100%" cellpadding="2" cellspacing="0" class="table">
                                        ...
                                        <tr> <th width="50%">本地端口</th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="sdnse_port" style="width: 120px" value="<% nvram_get_x("", "sdnse_port"); %>">
                                        ...
                                        <tr> <th width="50%">服务器组</th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="sdnse_name" placeholder="default" style="width: 120px" value="<% nvram_get_x("", "sdnse_name"); %>">
                                        ...
                                        <tr> <th>禁用IPV6解析</th>
                                            <td>
                                                <div class="main_itoggle">
                                                    <div id="snds_ipv6_on_of">
                                                        <input type="checkbox" id="snds_ipv6_fake" <% nvram_match_x("", "snds_ipv6", "1", "value=1 checked"); %><% nvram_match_x("", "snds_ipv6", "0", "value=0"); %>>
                                                    </div>
                                                </div>
                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" value="1" name="snds_ipv6" id="snds_ipv6_1" <% nvram_match_x("", "snds_ipv6", "1", "checked"); %>><#checkbox_Yes#>
                                                    <input type="radio" value="0" name="snds_ipv6" id="snds_ipv6_0" <% nvram_match_x("", "snds_ipv6", "0", "checked"); %>><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div id="wnd_sm_cou">
                                    <table width="100%" cellpadding="2" cellspacing="0" class="table">
                                        ...
                                        <tr id="ss_white_option">
                                            <th>加载ChnrouteIP为白名单</th>
                                            <td>
                                                <div class="main_itoggle">
                                        ...
                                        <tr id="ss_black_option">
                                            <th>加载ChnrouteIP为黑名单</th>
                                            <td>
                                                <div class="main_itoggle">
