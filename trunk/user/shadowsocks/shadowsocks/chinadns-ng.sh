...
func_cnng_file(){
    /usr/bin/chinadns-ng -b 0.0.0.0 -l 65353 -c $wan_dns,119.29.29.29#53 -t $SS_SERVER_LINK#$ss_tunnel_local_port -4 chnroute >/dev/null 2>&1 &
    #/usr/bin/chinadns-ng -c $wan_dns,119.29.29.29#53 -t $SS_SERVER_LINK#$ss_tunnel_local_port -4 chnroute >/dev/null 2>&1 &
